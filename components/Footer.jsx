    ...
    <footer className="site-footer">
      <div className="container footer-grid">
        <div className="footer-brand">
          ...
          <p>Εξειδικευμένες εργασίες διαμόρφωσης στη Θεσσαλονίκη με 25+ χρόνια εμπειρίας: καθαιρέσεις, γυψοσανίδες, τσιμεντοκονίες, πλακίδια και ανακαινίσεις μπάνιου.</p>
        </div>
